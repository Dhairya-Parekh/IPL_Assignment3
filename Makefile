...
all: parser lexer type_generator symbtab_generator
	$(CXX) $(CXXSTD) $(CXXDEBUG) -o iplC driver.cpp parser.o scanner.o symbtab.o type.o 
...
clean:
	rm parser.o scanner.o symbtab.o type.o iplC parser.tab.hh parser.tab.cc scanner.yy.cc stack.hh parser.output location.hh position.hh 