...
all: parser lexer type_generator symbtab_generator ast_generator
	$(CXX) $(CXXSTD) $(CXXDEBUG) -o iplC driver.cpp parser.o scanner.o symbtab.o type.o ast.o
...
clean:
	rm parser.o scanner.o symbtab.o ast.o type.o iplC parser.tab.hh parser.tab.cc scanner.yy.cc stack.hh parser.output location.hh position.hh 